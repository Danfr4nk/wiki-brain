...
connections:
  ...
  - page: wiki/people/annie-ulmer
    type: causes
    claim: "The dog is the one dependency that outlived the money, the drugs and the cohabitation — which is why the relationship reopened through him after every material channel had closed."
  - page: wiki/mind/synthesis/block-unblock-loop
    type: evidences
    claim: "Milo is the counterexample that widens the loop's dependency rule: the surviving channel that defeats a block need not be material, only needed."
  - page: wiki/people/valeria-iglesias-cid
    type: co-occurs
    claim: "Dan swore his feelings to Valeria on Milo — the dog functions as his oath object, the thing invoked when a statement needs to be unfalsifiable."
  - page: wiki/people/gabe
    type: parallels
    claim: "Gabe the cat and Milo share a deliberate provocative-naming pattern Dan uses as a social tripwire, reading how a stranger reacts to the name rather than the animal."
...
death is a separately documented, high-weight event in the relationship's
record — see [[wiki/people/annie-ulmer]]) and her parents kept a third dog,
**Lada**. As of early 2026 Milo was living with Dan in Leith-Hatfield, PA;
his status after the relationship's final closure in mid-2026 is not
confirmed in any source read so far.

Dan personifies him constantly in texts — a documented, recurring quirk
rather than a one-off bit: he narrates Milo's moods and voices opinions for
him ("Milo was being SO bad today... Screaming," "Milo asked"), a habit the
LIFE REPORT source flags as a signature of someone tone-conscious enough to
...
July 2026 record shows he is also, structurally, the most consequential
node in the corpus's endgame — and it is worth stating plainly, because
the MAX_PRIME exemption is exactly what kept it from being noticed
earlier.

After the [[wiki/timeline/events/group-chat-closure|June 1, 2026
closure]], contact with [[wiki/people/annie-ulmer|Annie]] stopped for
fifty-two days — the longest severance in a relationship whose record
holds 127 declared exits and 110 relapses inside 48 hours. Three
approaches from her in June went unanswered, including a request for
financial paperwork. What ended the silence was an email she sent over
the July 4 weekend asking whether Milo had been frightened by the
fireworks, resent around July 21 when nothing came back. Dan answered it
on July 23, and the relationship reopened
([[wiki/timeline/events/july-2026-recontact]]).

This makes the dog the single surviving dependency after the money, the
drugs, the cohabitation and the shared future were all gone, and it
widens the rule stated on
[[wiki/mind/synthesis/block-unblock-loop|the block/unblock loop]]: a
severance holds when nothing either party still needs runs through the
channel, and what runs through it need not be material. Across the four
days that follow, every de-escalation from hostility back into warmth
routes through him — photographs, a video, the baby blankets he adopted
during the move, the beggin' strips, the running joke about the toy lamb.
Annie's name for him in that exchange is "king baby"; Dan's account is
that Milo "saved my life," specifically on the night of May 31, and that
the dog "hasn't left my side since like may."

Dan's own framing of what the dog now carries is the closest thing in the
record to a statement of what he has left: "i made him a promise that,
