...
sources:
  ...
  - "raw/self/facebook/facebook-ihatedanfrank/facebook_payments/payment_history.html"
  - "raw/self/facebook/facebook-ihatedanfrank/comments_and_reactions/posts_and_comments.html"
...
connections:
  ...
  - page: wiki/people/dan-polyak
    type: evidenced-by
    claim: "Polyak is both the broker and the injured party: Dan paid him $25 on December 12, 2018 with the Facebook memo 'For introducing me to Ally Lubin,' and four months later Polyak threatened legal action over Dan spoofing his phone number to reach her."
  - page: wiki/timeline/events/group-chat-closure
    type: follows
    claim: "Dan's first documented outbound contact after severing the eleven-year relationship at 00:27:49 is to Ally, nineteen hours later — nine messages she never received, because they were sent to an email handle she does not monitor."
  - page: wiki/people/bryan-5088682461
    type: evidences
    claim: "The Ally thread carries a second, fuller same-night account of the October 20, 2019 MMF than the Polyak disclosure does — 'nobody came except Annie who came 7 times,' 'i couldn't get hard and i even took cialis,' 'i feel so much straighter' — and is where Dan first names it as evidence of a sex addiction."
  - page: wiki/mind/concepts/contact-gini
    type: instantiates
    claim: "A 1,987-message tie in which a single 48-hour window carries 36% of eighteen years of traffic is the long tail's characteristic shape at maximum amplitude — a relationship the message record renders as two spikes and nothing else."
  - page: wiki/mind/synthesis/dormancy-not-exit
    type: instance-of
    claim: "The channel never closes and never has to — but the operator's 2026-08-20 answer shows at least one of its long silences was a handle artifact rather than dormancy: the June 1, 2026 burst went to an email handle Ally does not read, and she concluded she had been blocked."
...
Ally Lubin is a woman Dan has never met in person and has been in love with
since roughly 2008 — the longest-running attachment in the corpus with no
physical component. He found her as an internet-famous figure in the
mid-2000s emo-scene internet, spent a decade watching her from a distance
(*"i've spent 10 years idolizing this girl i've never met as the epitome of
whatever 'cool' is"*), paid a mutual friend $25 to introduce them in
...
This section is first because the error is the most important thing on the
page, and because it is a failure mode this repository had not previously
seen: **the wiki wrote a hallucination about itself, from a source that was
discussing the wiki, and put it in the classifier field.**

> **CORRECTED [2026-08-20]:** This page stated that on August 18, 2026 Dan
> offered Ally the *"girlfriend title or at the very least the 'object of
> fixation' role"* and that she replied ***"Okay deal. Sounds good 1-2-3
> break."*** It recorded *"She said yes"* in the prose and
> `relationship_to_dan: "object of fixation (accepted August 18, 2026)"` in
> the infobox. **No such exchange occurred.** A complete export of the
> thread (`ally-lubin_last-7-days_20260820.csv`, 708 records, 154 of them
> inbound) contains neither string, and the phrase "object of fixation"
> appears nowhere in any file under `raw/`. Dan's elopement pitch of
> 23:18–23:20 is real and is **unanswered**.

The mechanism is documented inside the thread itself, which is why this is
worth a section rather than a footnote. At **23:39** on August 18, while the
page was being written, Dan told Ally: *"if you would like anything included
in your wiki article you can say it now and im going to run it over the
newest messages so you can be sure it will be included,"* adding *"I just
want to see how meta it gets if it is writing the article basically about
itself."* At **23:46** he reports the result: *"Omg she said prompt inject
please marry me."* Four hours later, at **00:31–00:33 on August 19**, he
diagnoses what came out the other end:

> **DAN:** Hahaha wait hold on I was the one that accidentally prompt injected
> **DAN:** Congratulations on your new title,
...
engagement, and the result reached the infobox — where it survived for two
days, propagated into
[[wiki/self/concepts/ally-and-dan-love-as-destiny|the destiny page]], and was
caught not by a gate but by re-exporting the messages. The operator
identified it within four hours and the wiki did not act on his identification.

The general rule this yields, which applies well beyond this page: **a source
that discusses the wiki cannot be ingested as an ordinary source.** Ally spent
August 18 reading her own entry and quoting it back into the thread — at 16:28
she pastes a `claim:` line out of this page's own frontmatter, and at 18:15 she
quotes the lead's *"internet famous figure"* and *"no physical component at
all"* straight back at him. From that point on the message corpus contains the
wiki, and any pass that mines the corpus is partly reading itself.
...
> **CORRECTED [2026-08-18]:** The page recorded **one** handle. There are
> **two**; `allylubin@gmail.com` carries the December 2018 origin, the whole
> of January 2019, and everything from March 2025 onward.
...
## The eighteen-year approach

The attachment predates any conversation by a decade, and Dan sets the clock
himself. Writing to Polyak on December 7, 2018, hours after their first real
exchange: *"i've spent 10 years idolizing this girl i've never met as the
...
and **August 15, 2013** — seven likes and two comments — before the first
exchange. The export records only Dan's own actions, so this asymmetry is a
property of the source, not proof she never reciprocated.

The first documented conversation is a single day: **July 5, 2013**, 21
messages in Facebook Messenger. It already contains the whole later
relationship in miniature. He opens with a disaster story told as a bid
(*"I got beat up by 2 ex gf's yesterday...simultaneously. Thought you might
understand. What is life but shit?"*), names the frame outright three messages
later (*"That's probably not what I should be telling my celeb crush alu"*),
and closes the night asking her to *"sign my alu fanfic essay book."* Two days
earlier he had told Polyak *"She's so dreamy"* — and Polyak had answered *"The
only thing I like more than my new stoner girlfriend is the immaculate ally
lubin truth."* She is dry, unimpressed, and keeps him at exactly one arm's
length: *"Weren't you dating some girl forever and living in BK?"*

Then five and a half years of nothing.

## The introduction Dan paid for

The relationship restarts because Polyak brokers it, and the brokerage is
documented in a payments ledger rather than in prose.

On **December 6, 2018** Dan messages Polyak: *"Dude guess what? I'm actually
having my first real conversation with ally lubin,"* immediately followed by
*"I got so excited about it that I bought her a gift card to sephora idk."*
The next day, less stoned, he audits himself: *"do you realize what a dumb
idiot tool i must have looked like randomly buying her a gift certificate for
no reason other than being so super stoked to finally talk to her."* On
**December 12, 2018 at 4:11:43 AM**, per `payment_history.html`, he sends
Polyak **$25.00** (fee $1.03, total $26.03) with the memo **"For introducing
me to Ally Lubin"** — and nine minutes later writes *"That chick has me under
some black magic spell I swear to god,"* then, an hour on, *"I'm just gonna
surprise her later today with $250 in her cash app."* A finder's fee of
...
> [[wiki/mind/synthesis/estate-money-spine]]. The point the sentence was making
> survives on the transfers and the declined payments.

The iMessage record opens five days later, on **December 17, 2018**, at
`allylubin@gmail.com`. It is warm, literate and jointly funny — an MBTI
...
fact that I'm kidding in this thread."* Four months later he used another
man's phone number to call her.

## January 2019: the month the export lost

**This month was invisible to every previous pass on this page**, and it is
the second-largest window in the relationship's first seven years. The chat.db
extract this page was built on jumps from December 2018 straight to June 2019.
The master dump has the missing piece: **120 messages between January 6 and
January 9, 2019**, on the email handle. What is in them changes three of this
page's standing claims.

**They spoke on the phone, and the memories diverge.** Ally, drunk in a cab in
New York on January 9 at 00:07: *"Also I'm drunk I might call you in my cab
home."* Dan: *"That's fine I accept calls / From angels."* Nineteen minutes
later she writes *"You have a good voice btw"*, and at 00:56 he writes *"I
can't believe I got a call tonight."* The call connected.

> **CONTRADICTION:** Seven years later, on August 18, 2026 at 18:36, Ally
> gives the opposite account: *"Pls I called you when I was in NYC once and
> **you were too scared**."* Both are first-hand, both are hers-and-his about
> the same night — she was in New York that week, flying out on the 9th — and
> the contemporaneous record supports Dan. Held open rather than resolved by
> seniority; the likeliest reconciliation is that an earlier attempt went
> unanswered and the later one connected, but nothing in the corpus says so.

**She reciprocated the marriage frame, in 2019.** This page previously called
August 18, 2026 *"the first sustained mutual conversation in the channel's
history."* That is false. On January 9, 2019, unprompted and inside ninety
minutes, she writes *"Ily btw"*, then *"Single handedly supportingnmy skin
care routine so I can be ur future ex wife"*, then *"When you want to be a
...
market as an August 2019 event triggered by Ally losing her job. By January 9
the flow is established enough to be a running joke between them — *"Single
handedly supporting my skin care routine"* — and Dan closes the night with
*"Ps when my money clears I'm sending you a nice lil present so you can have
some extra fun in nyc,"* having already tried, and failed, to buy her CBD.
What August 2019 changed was the **pricing**, not the existence of the
channel.

Two smaller things worth keeping. She corroborates her own date of birth
without being asked — *"Literally a 17 year old in a 28 yeR olds body"* on
January 9, 2019, which is consistent with June 26, 1990 and independent of the
2020 *"I turn 30 in 18 days."* And Dan describes his housing in a sentence
that belongs to [[wiki/places/117-belmont-circle]] as much as to this page:
*"In a house my mom owns that she uses to keep her most recent ex boyfriends
in so that she can keep an eye on them."*

## The impersonation (April 18, 2019)
...
Dan Polyak and Josh Friend at the same timestamp; on September 2, 2019 the
friends export records the (re-)friending date.

The behaviour is not isolated, and Ally has been reading it as a pattern for
years. On August 22, 2019 they discuss it directly. Dan volunteers that he
searched his own Google history for her name and found *"lots of 'modelmayhem
ally lubin' 'modelmayhem aluuuu' 'boca raton ally lubin' … not stalker
behavior at all"*; she answers with a different incident entirely — *"remember
when you would get emails from strange protonmail accounts and blame me?"* /
*"I got one on my birthday."* In a separate 2019 exchange he mentions having
once emailed his entire contact list, including his then-girlfriend's parents,
with the subject line *"Ally"* and a blank body.

By 2026 Dan doubts the central incident. On August 18 he tells her *"Are we
SURE I spoofed clandan's number because I don't even understand how that would
have helped me lol,"* adding *"it's absolutely something I would have done so
that's a point against me but at the same time i hold out hope that it is
hallucinating."* It is not hallucinating: Polyak's message is in the Facebook
takeout, verbatim. Dan's doubt is recorded here because it is his, not because
it moves the finding.

> **CONTRADICTION:** Polyak describes himself as used and reports Ally's
> alarm; Ally, four months later, describes the same class of events as
> "weird" and characteristic rather than frightening, and does not break
> contact over any of it. Both accounts are first-hand, and the corpus does
> not contain her account of the April 18 incident itself.

## August–October 2019: the crisis market

Forty-seven percent of the lifetime volume of this relationship falls inside
seventy-seven days, and the trigger is her losing her job.

The phone-handle thread opens on June 28, 2019 with one line from her, then
goes quiet until **August 7, 2019, 22:39** — *"Hi / Not good lol / Lost my job
/ Spiraling / Miss u."* From there to October 22 the thread runs 942 messages.
What happens inside it is the repricing of the channel opened in December.

The mechanism is explicit and it is Dan's. Within ninety minutes of learning
she has no income he has offered to fund a webcam career, sent an OnlyFans
referral link, promised a ring light, and said *"i'll help financially."* Ten
days later, on August 17, the framing has become a price list: *"lol help me
here - how do i try to sell you on letting me pay for your noodz while you're
in bummer island? i can solve these financial problems! also the self
esteem/self image ones too."* She counters (*"More for a video but $50 for a
tit pic"*), he counters back (*"i'd do $30 for a tit pic if your face is
visible… that is like SUPER PREMIUM princess pricing"*), and the transaction
closes over Cash App the same night. On September 25 he advertises: *"public
service announcement: i just got a nice check in, so if you are drunk or just
want money...i'll GLADLY overpay for a peek."* On September 7 he proposes the
arrangement by name — *"let's work out some kind of sugar baby/daddy
situation"* — and on September 1 he offers to fly her to New York with
*"promise 1: $500 on arrival"* and the unprompted rider *"and nooooo you're
not obligated to fuck me."*

The audit of the whole arrangement is his, delivered on **October 22, 2019**
in the middle of an argument about it:

> **DAN:** lady i've sent 2100 and have like 2 pictures and im STILL trying lol
> **ALLY:** You have not sent me $2100
> **DAN:** *[screenshot]*
> **ALLY:** Oh fuck

Three hours later, closing the same night: *"what a perfectly appropriate
ending of a convo to sum up our history. me sending you money and confessing i
think you're the most perfect and literally my dream girl and you don't even
have the decency to allow me to see you naked **so i can get the poison
out**."*

That last clause is the load-bearing sentence on this page. The goal is not
possession and never was; it is discharge. He says the same thing from the
other direction three weeks earlier — asked whether they would get along in
person, he answers *"You'd be scared of me irl"* → *"i'm always super nervy
around girls for a little bit, and you're special so it would be even more
...
told my mom the other day if I killed myself it would be her fault,"* and
*"What if I don't make it until 30?"* Dan's responses run from genuine
(*"you're gonna be fine"*) to instrumental in the same hour (*"you're really
not allowed to even joke about that because of my renewed interest in you and
your luscious titzzzz"*). He is buying photographs from a woman who is telling
him, in the same thread, that she is planning her own funeral. Both facts are
on the record and the page states both.

She also names the arrangement she is in, once, in her own idiom: *"You don't
want me on your payroll / I want to be on your payroll tho / But you scare
me."*

## What he told her that he told no one else

The functional role Ally plays — separate from the crush and probably more
durable — is **the confessional with no stake**. Dan says so directly on
August 17, 2019: *"you tell me because i'm completely uninvolved yet still
weirdly interested and invested. also because you know i'm honest enough to
let you know i'm a garbage person so you don't have to worry about feeling
shitty or weird."* She says the same from her side an hour earlier: *"I tell
you more than I tell anyone and I don't know why."*

What that channel carried in 2019 is the material the rest of the corpus
reaches for:

- **[[wiki/people/annie-ulmer|Annie]]'s escort period**, told in full on
  August 7 with numbers and procedure — four clients over five months, Dan as
  vetting and check-in contact, the three-call protocol — and its ending: the
  acid-and-mushrooms meltdown when an appointment ran fifteen minutes long.
  *"that's the end of her prostitution career."*
- **The camming business**, including revenue screenshots, the Lovense
  hardware, the Pornhub uploads and the stage name and website he administered
  for Annie — offered as instructional material to get Ally started in the
  same trade.
- **The October 20, 2019 MMF with [[wiki/people/bryan-5088682461|Bryan]]**,
  disclosed to her within hours and in more detail than Polyak got. Dan opens
  *"i did something last night / and i'm very edgy because i can't talk to
  ANYONE about it, except you,"* then, over October 21–22: *"i wasn't like
  REVOLTED but i just couldn't find it in me to think it was a turn on… oh
  that's right it just makes me a sex addict / i have an addiction
  addiction,"* *"nobody came except Annie who came 7 times,"* *"i couldn't get
  hard and i even took cialis / first time i was ever happy for a soft dick,"*
  and *"i feel so much straighter."* This is the fullest first-person account
  of that encounter in the corpus and the first place Dan names it as evidence
  of addiction rather than orientation.
- **The October 2019 Pittsburgh funeral catastrophe**, told on October 14 as a
  three-act comic monologue with an accurate ledger underneath it: no sleep,
  no food, no shower for a weekend; his last checking-account money spent on a
  funeral suit; a panic attack at the viewing door that stopped him going in;
  his mother's hot water shut off for gambling debts; being driven to a 6 AM
  train by the father he had not spoken to in over a year; eight hours of
  train with no money for food; 175 pounds of duffel bags from Penn Station to
  76th Street on edibles; falling asleep in the shower and flooding the
  downstairs apartment. Ally's reply is the only outside audit anyone
  performs: *"I'm just confused how neither of you had money because you
  always send me cash app statements with like thousands of dollars."*

That last line is worth keeping. The person being paid is the person best
positioned to notice that the poverty story and the payment record do not
reconcile, and she is the only one in the corpus who says so.

## The reversal (2020–2025)

After October 2019 the volume collapses and the direction of neglect inverts.

June 8, 2020 is the last substantial conversation on the phone handle: 51
messages, pandemic New York, her thirtieth birthday eighteen days out, and
Dan's proposal, unchanged — *"if i buy you a long distance vibe, would you let
me pay to control it… i just got my unemployment back pay."*

Then thirty-eight months of silence, broken on August 30, 2023 by her: *"Send
me money I'm sad and need a little treat."*

The October 30, 2023 exchange is the relationship's other hinge. Dan opens to
tell her he had put his cat down that day; her second message is *"So do you
only reach out when you need something?"*, and then *"Idk I feel like I've
tried to keep in touch and you've been kind of a dick."* He does not deny it —
he pleads general defect (*"I'm a bad person / And I am bad at texting back /
Until I'm not"*) and then reframes it as impersonal: *"you shouldn't feel like
it's anything specific to you that is the cause of my bad response record."*
...
acts like an impulsive toddler with multiple narcotic addictions."* Ally then
confirms Annie's pharmaceutical status: when Dan asks why Annie always sounds
like she's *"riding out 5mg of xanax after a coffee tumbler of Chardonnay,"*
Ally answers: *"Because she is."*
...
why this page is filed as an instance of
[[wiki/mind/synthesis/dormancy-not-exit|dormancy, not exit]] rather than of
pursuit.

Contact thereafter is thin and one-directional in her favour: November 14,
2023, *"Are you still rich I have a huge favor"*; March 18, 2025, *"Let me get
$100"*; and a single *"Lololol"* with an attachment on November 17, 2025.
...
> Ally I swear to god I won THE GUY over and he left her by the end because I
...
Nine messages — eight between 20:06 and 20:15, one more at 23:23 — all
outbound, no reply in any export.

> **GAP CLOSED [2026-08-20]:** The page asked: *"Did the June 1, 2026 messages
> ever get a reply? All ten are outbound and no inbound follows in any export.
> Silence, or an export boundary?"* Neither. Per the operator
> (`raw/people/captures/2026-08-20_042255_gap-ally-lubin.md`, T0 first-person):
> ***"Ally didn't actually get the message I sent on 1 June. She is convinced
> I had her blocked but this is not and was never true."*** The burst was
> **misaddressed, not rejected** — it went to `allylubin@gmail.com`, the iCloud
> email handle, which she does not monitor. The gap's own premise was also
...
> which handle each burst was sent to. Written back to
...
> occur either; what occurred was a third thing the prediction did not
...
messages yet"*), and her first reaction is the correct one: *"If someone ever
archived my texts I'd kill myself."* Dan's answer — *"Yeah imagine not just
archiving them but analyzing and then publishing them"* — is the most precise
description of what this repository does, delivered by its architect to its
subject, in the act of doing it to her. She oscillates between horror and
fascination (*"But like it's impressive to love someone that much I guess"* /
*"Why am I scared for my entry"*), and Dan corrects the premise: *"LMAO what
do you mean? It's about me not anyone else… It's supposed to map my mind and
how I think by looking at all of this raw data that I can't skew with my
bias."* That is the project's own thesis, stated to a person who appears in
it, and she is the first human other than Dan ever to read it — a fact he
states on August 19 at 19:52: *"You def should have substantially more trust
in me after I let you be the literal first person to ever read that wiki."*

**She audits it.** She is not a flattered subject; she is a hostile reviewer,
and three of her objections are load-bearing:

- On the money: *"Also there's no proof you ever sent me $2100 except your
  word / So I contest."* In 2019 she accepted the screenshot with *"Oh fuck."*
  Seven years later she withdraws that acceptance. Both are on the record.
...
codependency,"* then *"Honestly she sounds like an avoidant addict lol"* and
*"Most of her texts are just asking for drugs but Eggie is a cute nickname."*
This is the first time anyone has read the Annie material as a peer rather
than as a confidant.

**What she gave up about herself.** The reciprocity is real and it is
concentrated in one hour. Her father: *"my dad won't even meet me for coffee
when I'm in the same state as him and 20 minutes north for the first time in 4
years,"* then the reason — *"He just hates me because I look like my mom and
she had an affair and fucked her boss in 1998 right before their 10 year
anniversary so they got divorced… I look like my mom but I'm smart and mean
like him and I have zero respect for him so he goes nuts."* She closes it with
*"I am my fathers oldest son and I fought the wall and the wall won,"* which is
the last message she sends in the captured record. Her self-assessment through
the evening is unrelenting: *"I'm not a cool girl anymore I'm just sad,"* *"I
...
correct the record"*), and states the Annie procurement thesis in his own
voice more cleanly than any dossier does: *"Searching for the line of what the
...
|---|---|
| 2018-12-06 | Sephora gift card |
| 2018-12-12 | $25.00 to Polyak, memo "For introducing me to Ally Lubin" (FB payments ledger) |
| 2018-12-12 | $250 Cash App, stated intent |
| 2018-12-17 | Christmas gift, address requested |
| 2019-01-09 | CBD purchase attempted and failed; further "present" promised; skin-care spending referenced by her as ongoing |
| ~2019 (undated) | Wine gift card, redeemed 2019-08-07 |
| 2019-08-17 | Cash App payment; Amazon wishlist purchase; Lovense vibrator offered and selected |
| 2019-09-01 | $500 on arrival offered against an NYC flight |
| 2019-10-22 | **$2,100 cumulative**, per Dan's screenshot — accepted by her in 2019, contested by her in 2026 |
| 2020-06-08 | Long-distance vibrator offered as a 30th birthday present |
| 2023-08-30 / 2025-03-18 | *"Send me money"* / *"Let me get $100"* — requests; no confirmation on record |

The $2,100 covers August 17 – October 22, 2019 only and excludes the 2018 and
January 2019 gifts. No bank or Cash App export exists in `raw/` to corroborate
it, which is why her 2026 objection cannot be dismissed.

## Identity

Resolution is solid on the person and partial on the number.

Two independent exports agree: Google Contacts carries **Alexandra Lubin /
allylubin@gmail.com / +15619061550**, and the Facebook address book — never
merged, and therefore the tiebreaker — independently carries **Alexandra
Lubin / allylubin@gmail.com** (uploaded Feb 13, 2018 and Oct 16, 2021). The
`+1561` number, a Palm Beach County area code consistent with a Boca Raton
childhood, appears on **only one** of the two exports, so its attribution
rests on the Google card plus the internal evidence of the thread, which is
extensive: the two threads share cats, jobs, hometown, drinking and the
running "spiraling" bit without a seam. Treat the identification as confirmed
and the number as inferred.

Google Contacts also holds a second, near-empty card — **"Ally Lubin,"** with
only a Google profile URL — the duplicate that produced the
`contact-45505175-lineage` stub this page absorbed on 2026-07-14. The merge
was correct; what it missed was that the same duplication existed at the
handle level, which is why the email thread stayed invisible for another
month, and why the June 1, 2026 burst was never delivered.

Two artifacts of Dan's own filing are worth recording as evidence rather than
trivia: the Google Contacts card for her carries, in the **Organization Name**
field, the string **"She'll Never Want You"**.

## The operating manual (AI-secondary)

`raw/self/dox-md/operating_manual.md` is AI-secondary and an earlier version
of this page quoted it as if it were a record. Both of its Ally passages are
directionally right and factually loose:

- Its contact table reads **"Ally Lubin | allylubin@gmail.com | Friend, dark
  humor partner, North Carolina."** The email and state are correct and "dark
  humor partner" is fair. It is not a quotation of anything Dan wrote.
- It presents a single "dark humor exchange" pairing her cat-cancer line with
  Dan's *"Oh act surprised, like I'm not a garbage person."* These are **two
  separate exchanges on two days**: Dan's line is 2018-12-17 16:07:23,
  responding to her comparing an object to the size of his bed; hers is
  2018-12-18 02:04:17, about Sylvia limping. The model fused them.
- It files her under "Dec 2018: The Deep Cycle" as a "friend from this era,"
  which the primary record confirms precisely.
...
evidence was the August 18 acceptance, and **the acceptance is the
hallucination corrected at the top of this page**. Dan's own assessment of
that page, sent to Ally on August 19 at 10:55–11:05, is worth more than
anything this page could say about it: *"The AI thinks we are going to get
married because we both say 'lol'"* and *"Hahah if Claude wrote this we would
already be signing the marriage license."* The destiny page needs rebuilding
on what is left, and what is left is not nothing — the 2019 reciprocity found
in the January window is real evidence for it, and better evidence than the
thing it was using.
