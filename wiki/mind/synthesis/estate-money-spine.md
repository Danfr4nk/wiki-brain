...
connections:
  ...
  - page: wiki/timeline/periods/2020-2021-market-era
    type: contains
    claim: "The market era opens within weeks of the Sept 1 2020 estate check — the inheritance is the probable stake behind the ~$15k FSLY position and the $25k Robinhood peak, a temporal join the corpus supports but never states (flagged as inference)."
  - page: wiki/people/annie-ulmer
    type: contains
    claim: "The ~$119–123K net payment-app outflow to Annie is the spine's largest documented drain — the single biggest destination of Dan's lifetime capital anywhere in the record, roughly the size of the entire estate distribution."
  - page: wiki/places/337-saratoga-drive
    type: contains
    claim: "The $465k sale is the spine's next capital event and the first where Dan is bystander rather than beneficiary — the family-built asset liquidating around him while his own housing lands on the unpapered 463 arrangement."
  - page: wiki/legal/463-morgantown
    type: contains
    claim: "463 is where the spine currently points: no lease, blended agency, a ~July 2026 mechanics-lien deadline, and no absorber for a lien-sized shock — the housing configuration produced by the capital timeline's present state."
  - page: wiki/timeline/periods/2025-collapse
    type: contains
    claim: "The collapse period carries the spine's terminal accounting: the three-rotation earner see-saw with Annie, the 2026 'broke' status, and the return to PA framed as escaping metropolitan financial drains to manage regional assets."
...
a single causal chain — from the two family source-lines, through the
2020 estate distribution, the market era, the wage years, and the
decade's largest single drain, down to the 2026 state (broke, housed on
an unpapered arrangement with a lien clock running). Read as one system,
the spine explains the biography's central financial puzzle: how a life
positioned downstream of genuine family capital — a coal-region estate
on one side, a successful auto-parts chain on the other — repeatedly
lands at water-shutoff poverty, and why every capital arrival dissipates
on a timescale of months.

## The two source-lines and their trustee
...
"kushy" Republican-household origin period. Both lines reached Dan only
as gifts and distributions: Fran's "$100/year" protocol and the NS7
...
source-lines at once: "it feels super gross knowing that dad fought to
keep frank's auto employees from unionizing and that we have such kushy
lives because of it," alongside discomfort that the Fran inheritance
traces to a coal baron. The
[[wiki/mind/synthesis/2020-left-turn|left turn]]'s class-guilt clinch was
...
| 2020-09 | FSLY position opened (~$15k portfolio) | market stake |
| 2021-01 | Robinhood peak | ~$25k |
| 2021-02 | CCIV bloodbath day | −$6k |
| early 2021 | "The money just ran out" → Au Za'atar hire (Mar 2021) | ~$0 |
| 2021–2024 | Wage era; 2023 landlord-debt accumulation | wages |
...
The decade's biggest documented capital flow is not rent, drugs, or the
market. It is [[wiki/people/annie-ulmer|Annie]]: ~$139K sent against
~$16–20K received across Cash App and Venmo — a net outflow of roughly
**$119K–$123K**, approximately the size of the entire estate
distribution. The financial history of the relationship is a
three-rotation see-saw (Dan funds the early NYC years → Dan works
through the 2023 landlord-debt stretch → Annie sole earner through 2024
after the involuntary job loss), but the see-saw's net is six-to-one in
her favor. Set against the source-lines, the spine's shape is complete:
**family capital entered from two lines Dan never controlled, and the
largest share of what reached him exited through a relationship whose
terminal phase ran on him controlling her supply** — the money and the
supply network are the same architecture at different layers.
...
agent/tenant/caretaker role. The spine has no bank in it, in the
...
- No exit accounting for the market era; final P&L undocumented.
- The six months September 2020 → early 2021 have endpoints but no
  ledger; the burn decomposition (rent vs. supply vs. Annie vs. market)
  is not separable from current sources.
- The payment-app totals are operator-provided screenshots, not in
