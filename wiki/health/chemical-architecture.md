...
aliases: ["substance stack", "the chemical triad"]
status: active
importance: high
...
Dan runs a deliberately engineered neurochemical system and explicitly
rejects the recovery-industry frame for it. The load-bearing fact: **daily
Suboxone since February 17, 2010 — sixteen years, zero relapses** — on top
of which sit cocaine as a daily "cognitive accelerant," nicotine as ritual
regulator, daily cannabis, and a hard, fifteen-year zero on alcohol
(active aversion, rooted in the pervasive multi-generational family
alcoholism). The deviance audit scores this domain 99/100 against the
population baseline — the single most statistically extreme fact about him
— precisely because of its deliberateness: "not casual use; self-administered
neurochemical engineering" ([[wiki/mind/profile/deviance-mapping]]).
...
health record and the relationship record keep intersecting. [[wiki/people/tom]]
is the standing supply line (Suboxone strips, mushrooms, cocaine, klonopin
— "shows up with substances and announces it"), and his May 2026 no-show
...
## The frame, and its audit

The corpus's own framing is engineering: substances as hardware components
tuned to "maintain extreme cognitive and existential intensity without
succumbing to total chaos." The wiki records that frame as the documented
self-model while flagging what it elides: the withdrawal vulnerability is
real (May 2026 demonstrated the system fails hard when one supplier
flakes); the daily-cocaine baseline sits atop a 96th-percentile
impulsiveness score; and the framing itself is load-bearing identity — "the
