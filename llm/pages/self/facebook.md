...
| [[wiki/self/facebook/messages]] | 403 message threads — Annie/Eggie thread, key nodes, spam floor |

| [[wiki/self/facebook/posts]] | Posts, media, 17+ albums, 2007 origin-era status updates |

| [[wiki/self/facebook/friends]] | ~650-friend network, add/remove history |

| [[wiki/self/facebook/interests]] | Likes, events, groups, ads profile, off-Facebook tracking |

## Identity & Profile Data (2022 snapshot, self-reported)

| Field | Value |

|-------|-------|

| Name / handle | Dan Frank — ihatedanfrank (also Instagram); danfrank (Twitter); danfr4nk (Snapchat) |

| Registration | Tuesday, January 9, 2007, 3:40 AM UTC-4 |

| Emails | ihatedanfrank@gmail.com, dfrank88@gmail.com, thedanfrank@facebook.com (previous) |
...
| Export size / date | 79 MB zip, Sep 5 2022 (covers 2007–2022) |

| Message threads | 403 (271 inbox, 128 filtered, 3 requests) |
